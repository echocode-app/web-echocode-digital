  ...
  return (
    <div className="group relative shrink-0">
      <button
        type="button"
        aria-label={label}
        className={`inline-flex h-5 w-5 items-center justify-center rounded-full border border-transparent bg-black/30 font-main text-main-xs leading-none text-gray75 transition duration-main hover:text-accent-hover focus-visible:text-accent-hover focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent-hover ${buttonClassName}`}
      >
        {icon}
      </button>
