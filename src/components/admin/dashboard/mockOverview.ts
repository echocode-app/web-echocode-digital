...
export const DASHBOARD_OVERVIEW_MOCK: DashboardOverviewDto = {
  ...
  sources: [
    { source: 'google', leads: 251, share: 32.02, conversionRate: 4.76 },
    { source: 'linkedin', leads: 188, share: 23.98, conversionRate: 6.12 },
    { source: 'direct', leads: 143, share: 18.24, conversionRate: 3.81 },
    { source: 'clutch', leads: 119, share: 15.18, conversionRate: 7.24 },
    { source: 'upwork', leads: 82, share: 10.58, conversionRate: 5.58 },
  ],
  leadVelocity: {
    leadsLast7Days: 228,
    leadsLast30Days: 918,
    averageDaily7d: 32.57,
    averageDaily30d: 30.6,
    velocityRatio: 1.06,
    direction: 'stable',
  },
  trafficQualityInsight: {
    conversionTrendSlope7d: -0.04,
    trafficTrendPct7d: 8.52,
    conversionTrendPct7d: -3.48,
    warning: true,
    message: 'Traffic is rising while lead conversion is declining over the last week.',
  },
