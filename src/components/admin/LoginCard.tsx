...
export default function LoginCard({ forbidden = false }: LoginCardProps) {
  return (
    <section
      className="rounded-secondary border border-white bg-[rgba(0,0,0,0.8)] 
    ...
    >
      <div className="mb-6 flex items-start justify-between gap-4">
        <div className="space-y-2">
          <p className="font-main text-title-xs uppercase tracking-[0.24em] text-gray60">
            Admin panel
          </p>
          <h1 className="font-title text-title-2xl text-white">Sign in</h1>
          <p className="font-main text-main-sm text-gray75">
            Use your Google account with admin access
          </p>
          {forbidden ? (
            <p className="mt-1 px-1 py-0.5 font-main text-main-xs font-bold text-accent">
