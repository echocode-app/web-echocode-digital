  ...
  return (
    <article className="rounded-(--radius-base) border border-gray16 bg-base-gray p-4">
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <div>
          <label htmlFor="email-submissions-status-filter" className="mb-1 block font-main text-main-xs text-gray60">
            Status
          </label>
          <div className="relative">
            <select
              ...
              aria-label="Filter email submissions by status"
        ...
        <div>
          <label htmlFor="email-submissions-date-from" className="mb-1 block font-main text-main-xs text-gray60">
            Date from
          </label>
          <input
            ...
            aria-label="Filter email submissions from date"
        ...
        <div>
          <label htmlFor="email-submissions-date-to" className="mb-1 block font-main text-main-xs text-gray60">
            Date to
          </label>
          <input
            ...
            onClick={(event) => openDatePicker(event.currentTarget)}
            onFocus={(event) => openDatePicker(event.currentTarget)}
            aria-label="Filter email submissions to date"
