  ...
  return (
    <article className="space-y-4 rounded-(--radius-base) border border-gray16 bg-base-gray p-4">
      ...
      <div className="rounded-(--radius-secondary) border border-gray16 bg-black/20 p-3">
        <p className="font-main text-main-xs text-gray60">Links</p>
        <div className="mt-2 flex flex-col gap-2">
          <a
            href={details.profileUrl}
            target="_blank"
            rel="noreferrer"
            className="rounded-(--radius-secondary) border border-gray16 px-3 py-2 font-main text-main-sm text-white transition duration-main hover:border-accent"
          >
