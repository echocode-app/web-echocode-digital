    ...
    <header className="flex items-center justify-between border-b border-gray16 px-4 py-4 md:px-6">
      <div className="flex items-center gap-3">
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-(--radius-secondary) border border-gray16 text-gray75 transition duration-main hover:text-white md:hidden"
        >
      ...
      <div className="text-right">
        <p className="hidden font-main text-main-sm text-gray75 sm:block">{email ?? 'No email'}</p>
