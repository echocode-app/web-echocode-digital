...
- client-project form handoff: `src/app/docs/CLIENT_PROJECT_FORM_FRONTEND_HANDOFF.md`
...
1. Отримати upload URL:

- `POST /api/forms/client-project/image/init`

2. Завантажити файл по signed URL

3. Додати отриманий `image` payload у `POST /api/forms/client-project`
