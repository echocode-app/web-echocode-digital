      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 font-main text-main-sm text-gray75">
            Metrics for the client contact modal flow, without the separate email-only submissions queue.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center rounded-(--radius-base) border border-[#4b86ff]/40 bg-[#4b86ff]/10 px-4 py-2 font-title text-title-xs uppercase tracking-[0.12em] text-[#b8cdff] transition duration-main hover:border-[#4b86ff]/70 hover:text-white"
